...
Route::group(['middleware' => ['auth','role:'.\App\Models\Role::USER], 'as' => 'user.', 'prefix' => 'user', 'namespace' => 'User'], function() {
    ...
    Route::get('/dashboard/templates/{id}', [UserDashboardController::class, 'gettemplates'])->name('dashboard.gettemplates');
    Route::get('/dashboard/questions/{id}', [UserDashboardController::class, 'getquestions'])->name('dashboard.getquestions');
});