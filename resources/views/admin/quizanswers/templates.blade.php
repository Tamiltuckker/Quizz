                ...
                <div class="card">
                  <div class="card-header mx-4 p-3 text-center">
                    <div class="icon icon-shape icon-lg bg-gradient- text-center border-radius-lg">
                        ...
                        <img src="{{ asset('/storage/image/' .$answeredTemplate->category->image->image) }}" height=50 width=50>
                        @else
                   ...
                   <div class="card-body pt-0 p-3 text-center">
                    ...
                    <span class="text-xs">No Of Questions:{{$answeredTemplate->quiz_questions->count() }}</span>
