                            ...
                            <form method="POST" name="questions" enctype="multipart/form-data"
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="summernote" name="description" rows="4" cols="50" placeholder="Description"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="container">   
                                    ...
                                    <div class="row">
                                        <div class = "col-sm-2">
                                            ...
                                            {{ Form::radio("quiz_option[0][is_correct]", '1',null, ['class' => 'custom-control-input single-type', 'id' => '0-single-type']) }}
                                        </div>
                                        <div class = "col-sm-8">
                                    ...
                                    <div class="row mt-2">
                                        <div class = "col-sm-2">
                                            ...
                                            {{ Form::radio("quiz_option[1][is_correct]", '1',null, ['class' => 'custom-control-input single-type', 'id' => '1-single-type']) }}
                                       </div>
                                        <div class = "col-sm-8">
                                    ...
                                    <div class="row mt-2">
                                        <div class = "col-sm-2">
                                            ...
                                            {{ Form::radio("quiz_option[2][is_correct]", '1',null, ['class' => 'custom-control-input single-type', 'id' => '2-single-type']) }}
                                        </div>
                                        <div class = "col-sm-8">
