                        ...
                        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <x-text-input id="name" class="form-control" type="text" name="name"
                                    :value="old('name')" required autofocus placeholder="Name" aria-label="Name" />
                                <x-input-error :messages="$errors->get('name')" class="mt-2" />
                            </div>
                            <div class="mb-3">
                                <x-text-input id="email" class="form-control" type="email" name="email"
                                    :value="old('email')" required placeholder="Email" aria-label="Email" />
                            ...
                            <div class="mb-3">
                                <x-text-input id="password_confirmation" class="form-control" type="password"
                                    ...
                                    aria-label="Password" placeholder="Confirm Password" required />
                            ...
                            <div class="form-check form-check-info text-start">
                                ...
                                <label class="form-check-label" for="flexCheckDefault">
                                    I agree the <a href="javascript:;" class="text-dark font-weight-bolder">Terms and
                                        Conditions</a> and <a target="_blank" href="{{ route('auth.privacy') }}" class="text-dark font-weight-bolder">Privacy Policy</a>
                                </label>                                
                            </div>
